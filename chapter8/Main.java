...
// 実行方法
// javac chapter8/Main.java chapter8/listfactory/ListFactory.java
// java chapter8/Main chapter8/list.html chapter8.listfactory.ListFactory
// javac chapter8/Main.java chapter8/divfactory/DivFactory.java
// java chapter8/Main chapter8/div.html chapter8.divfactory.DivFactory
// ポイント
// factoryパッケージにしか依存していないこと<->listfactoryパッケージに依存していない
public class Main {
    public static void main(String[] args) {
        ...
        Page pg = factory.createYahooPage();
        pg.output(filename);
    }
}
